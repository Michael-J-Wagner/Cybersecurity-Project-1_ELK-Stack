...
These files were tested and used to create a live ELK deployment on the Azure cloud platform.
They can be used to build the entire deployment pictured above, or select portions of the
