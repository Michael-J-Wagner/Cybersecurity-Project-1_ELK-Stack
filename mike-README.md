...
The data collected by these two Beats is used to build and share dashboards in Kibana that show system-level CPU usage, memory, file system, disk IO, network IO statistics, and more.
